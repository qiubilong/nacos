...
public class InstanceController {
    ...
    public String register(HttpServletRequest request) throws Exception { /* ## 注册服务 */
        ...
        serviceManager.registerInstance(namespaceId, serviceName, instance);/* ## 注册服务 */
        return "ok";
    }
    ...
    @PutMapping("/beat")
    @Secured(parser = NamingResourceParser.class, action = ActionTypes.WRITE)
    public ObjectNode beat(HttpServletRequest request) throws Exception { /* ## 服务定时心跳 */
