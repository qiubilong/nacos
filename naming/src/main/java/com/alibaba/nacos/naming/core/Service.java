 ...
 * @author nkorange
 */
@JsonInclude(Include.NON_NULL)  /* 服务多个集群 */
public class Service extends com.alibaba.nacos.api.naming.pojo.Service implements Record, RecordListener<Instances> {
    ...
    private Map<String, Cluster> clusterMap = new HashMap<>();/* 服务多个集群 */
    ...
    public void updateIPs(Collection<Instance> instances, boolean ephemeral) {
        ...
        for (Instance instance : instances) {
            try {
                ...
                if (!clusterMap.containsKey(instance.getClusterName())) {
                    ...
                    Cluster cluster = new Cluster(instance.getClusterName(), this); /* 创建服务集群分组 */
                    cluster.init();
        ...
        for (Map.Entry<String, List<Instance>> entry : ipMap.entrySet()) {
            ...
            clusterMap.get(entry.getKey()).updateIps(entryIPs, ephemeral); /* ## 替换更新服务实例列表 */
        }

        setLastModifiedMillis(System.currentTimeMillis());
        getPushService().serviceChanged(this); /*  ## 异步UDP广播服务实例 */
