...
public class NacosNamingService implements NamingService {
    ...
    public void registerInstance(String serviceName, String ip, int port, String clusterName) throws NacosException {
        registerInstance(serviceName, Constants.DEFAULT_GROUP, ip, port, clusterName);/* ## 注册服务 */
    }
    ...
    public void registerInstance(String serviceName, String groupName, Instance instance) throws NacosException {
        ...
        if (instance.isEphemeral()) {
            ...
            beatReactor.addBeatInfo(groupedServiceName, beatInfo); /* ## 服务心跳保活 */
        }
        serverProxy.registerService(groupedServiceName, groupName, instance); /* ## 注册服务 */
    }
